...
//para fazer busca com autocomplete, foi utilizado o bootstrap 
export class CitiesTypeaheadComponent implements OnInit, ControlValueAccessor {
  ...
  ngOnInit() {
    this.dataSource$ = new Observable(
      ...
      .pipe(
        /*
        *switchMap interrompe a execução se vier uma nova informação em cima, ele cancela a requisição caso venha uma nova informação e faz outra
        *requisição com essa nova informação
       */
